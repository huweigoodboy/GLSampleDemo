...
import com.android.huwei.gl.render.CubeLightRender
...
class CubeLightActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mRenderer = CubeLightRender(this)
