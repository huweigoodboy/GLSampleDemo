 ...
 */
class CubeLightRender : GLSurfaceView.Renderer {
    private val A_POSITION = "a_Position"
    private val U_MATRIX = "u_Matrix"
    private val U_TEXTURE_UNIT = "u_TextureUnit"
    private val U_LIGHT_DIRECTION = "u_LightDirection";
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_CUBE_MAP, cubeTexture)
        GLES20.glUniform1i(uTextureUnitLocation, 0)

        GLES20.glUniform3f(uLightDirectionLocation, -1.0f, 1.0f, 1.0f);
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        GLES20.glFrontFace(GLES20.GL_CW)  //设置顺时针是正面

        val vertexShaderSource: String = readTextFileFromResource(context, R.raw.cubelight_vertex_shader)
        val fragmentShaderSource: String = readTextFileFromResource(context, R.raw.cubelight_fragment_shader)
        ...
        uLightDirectionLocation = GLES20.glGetUniformLocation(program, U_LIGHT_DIRECTION)
    }
